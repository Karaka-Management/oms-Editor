...
<div class="row">
    <div class="col-xs-12">
        <div class="box">
            <ul class="crumbs-2">
                <li data-href="<?= UriFactory::build('{/base}/editor/list?path=/Accounts/' . $accountDir); ?>"><a href="<?= UriFactory::build('{/base}/editor/list?path=/Accounts/' . $accountDir); ?>"><i class="g-icon">home</i></a>
